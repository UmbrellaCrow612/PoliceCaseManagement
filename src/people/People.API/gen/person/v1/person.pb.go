...
func (x *GetPersonByIdResponse) GetDateOfBirth() *timestamppb.Timestamp {
	if x != nil {
...
const file_common_person_proto_rawDesc = "" +
	"\n" +
	"\x13common/person.proto\x12\tperson.V1\x1a\x1fgoogle/protobuf/timestamp.proto\"4\n" +
	...
	"\bpersonId\x18\x01 \x01(\tR\bpersonId\"\xe3\x01\n" +
	...
	"\rGetPersonById\x12\x1f.person.V1.GetPersonByIdRequest\x1a .person.V1.GetPersonByIdResponseB\x18Z\x16gen/person/v1;personv1b\x06proto3"
...
var file_common_person_proto_depIdxs = []int32{
	4, // 0: person.V1.GetPersonByIdResponse.dateOfBirth:type_name -> google.protobuf.Timestamp
	0, // 1: person.V1.PersonService.DoesPersonExist:input_type -> person.V1.DoesPersonExistRequest
	2, // 2: person.V1.PersonService.GetPersonById:input_type -> person.V1.GetPersonByIdRequest
	1, // 3: person.V1.PersonService.DoesPersonExist:output_type -> person.V1.DoesPersonExistResponse
	3, // 4: person.V1.PersonService.GetPersonById:output_type -> person.V1.GetPersonByIdResponse
